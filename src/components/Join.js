          ...
          <div className="row">
            <div className="col-lg-6 col-12 offset-lg-6">
              <div className="content">
                <h2 className="color-white text-xl-center">
                  Ready to Play? Join Now!
                </h2>
                <h5 className="color-white text-xl-center">
                  Join Us for hosting your tournaments with us<br/> to make it visible to the people remotely....
                </h5>
                <a href="contact.html" className="cus-btn sec">
                  Join Now
                  <svg
